...
function ColumnLayouts(props) {
    ...
    return (
        <div className={"column-layouts-editor" + (props.className ? ` ${props.className}` : "")}>
            <button className={`column-button column-1-of-1 ${selected === 1 ? 'selected' : ''}`} value={"1/1"} onClick={() => handleClick(1)}>
                <span className='column'> 1/1 </span>
            </button>
            <button className={`column-button column-1-of-2 ${selected === 2 ? 'selected' : ''}`} value={"1/2"} onClick={() => handleClick(2)}>
                <span className='column'> 1/2 </span>
                <span className='column'> 1/2 </span>
            </button>
            <button className={`column-button column-1-of-3 ${selected === 3 ? 'selected' : ''}`} value={"1/3"} onClick={() => handleClick(3)}>
